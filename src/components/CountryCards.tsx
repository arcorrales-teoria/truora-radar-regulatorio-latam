 ...
 *
 * Se intentó una versión con el patrón "ShiftCard" (foto que se encoge a
 * una miniatura al hover), pero con ESTAS imágenes específicas (ya traen
 * título y badges incrustados, compuestos para verse grandes) el
 * encogimiento a una miniatura de ~70-150px volvía ese texto ilegible y
 * la card se veía descompuesta — se revirtió a este diseño, que ya
 * funcionaba bien.
 */
